        ...
        <table v-else class="min-w-full">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="contact in displayedContacts" :key="contact.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
              <td class="px-5 py-4"><span class="font-medium text-gray-800 dark:text-white">{{ contactStore.getFullName(contact) }}</span></td>
              ...
              <td class="px-5 py-4 text-sm text-gray-700 dark:text-gray-300">{{ contact.client_name || '—' }}</td>
