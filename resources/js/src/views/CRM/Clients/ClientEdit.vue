            ...
            <div>
              ...
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                  ...
                  <p class="ml-6 text-sm text-gray-500 dark:text-gray-500">
                    Inactive clients are hidden from most lists but can be reactivated anytime
                  </p>
                </div>
              </div>
            </div>
...
async function loadClient() {
  ...
  try {
    ...
    formData.is_active = client.is_active !== false
  } catch (error) {
...
async function handleSubmit() {
  ...
  try {
    ...
    const updatedClient = await clientStore.updateClient(clientId, {
      ...formData,
      // Trim string values
    ...
    if (error.response?.data?.messages) {
      ...
      generalError.value = error.response?.data?.message || 'Failed to update client. Please try again.'
    }
  } finally {
    saving.value = false
  }
